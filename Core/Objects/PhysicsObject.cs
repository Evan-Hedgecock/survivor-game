...
public class PhysicsObject : GameObject
{
    ...
    public float VelocityX
    {
        ...
        set { _velocity.X = Math.Clamp(value, -1 * Speed, Speed); }
    }
    public float VelocityY
    {
        get { return _velocity.Y; }
        set { _velocity.Y = Math.Clamp(value, -1 * Speed, Speed); }
    }
    ...
    {
        _maxVelocity = new Vector2(Speed, Speed);
        _minVelocity = new Vector2(-1 * Speed, -1 * Speed);
    }
